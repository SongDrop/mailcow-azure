...
echo "Requesting wildcard SSL certificate for ${base_domain}..."
...
ln -sf /etc/letsencrypt/live/${base_domain}/fullchain.pem data/assets/ssl/cert.pem
ln -sf /etc/letsencrypt/live/${base_domain}/privkey.pem data/assets/ssl/key.pem
